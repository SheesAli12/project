  ...
  ;({
    ...
    documentIsReady: function () {
      this.$document
        ...
        .on('click.' + this.customID, this.hideSearchBar.bind(this)),
        this.$window
          .on(
            'load.' + this.customID,
    ...
    autoHeightSetOnHeader: function (t) {
      var i = e('.navigation-wrapper'),
        ...
        a = e(
          '.navigation-wrapper > .main-navigation-area *:not(.logo):not(.header_btn):not(.cart-icon-wrap *):not(.dropdown-menu):not(.search-button *)',
        ),
        n = 0
        ...
        ('block' == e('div.main-mobile-nav').css('display')
          ? (s.each(function () {
            ...
            e('.breadcrumb-nav').hasClass('breadcrumb-sticky-on') &&
              e('.main-navigation').hasClass('is-sticky-on') &&
              e('.main-mobile-nav').hasClass('is-sticky-on') &&
              e('.breadcrumb-sticky-on').css('top', n - 1))
          : (a.each(function () {
              var t = e(this).outerHeight(!0)
              t > n && (n = t)
            }),
    ...
    mainMenuAccessibility: function () {
      var e,
        t,
        i,
        s = document.querySelector('.main-mobile-build')
      let a = document.querySelector('.header-close-menu'),
        ...
        o = n[n.length - 1]
      if (!s) return !1
      for (t = 0, i = (e = s.getElementsByTagName('a')).length; t < i; t++)
    ...
    hideSearchBar: function (t) {
      ...
      e(t.target).closest(i).length ||
        e(t.target).closest(s).length ||
        (this.$body.hasClass(this.classes.searchPopUpActive) &&
          (this.$body.removeClass(this.classes.searchPopUpActive),
          i.focus(),
          t.stopPropagation()))
    },
      ...
      e(document).on('keydown', function (t) {
        if (e('body').hasClass('header-search-active')) {
          var i = document.activeElement,
            ...
            o = 9 === event.keyCode,
            c = event.shiftKey
          !c && o && n === i && (event.preventDefault(), a.focus()),
            c && o && a === i && (event.preventDefault(), n.focus())
        }
      })
    },
    headerAboveAccessibility: function () {
      if (e('.above-header').length > 0) {
        ...
        let e =
          ...
          r = c[c.length - 1]
        if (!a) return !1
        for (i = 0, s = (t = a.getElementsByTagName('a')).length; i < s; i++)
          t[i].addEventListener('focus', n, !0),
            t[i].addEventListener('blur', n, !0)
        function n() {
    ...
    headerAboveBarMobile: function () {
      if (e('.above-header').length > 0) {
        ...
        $('.header-above-wrapper').children().length > 0
